...
Router.get("/:post_id", ProtectedRoute_1.default, (0, CatchError_1.default)(Controller.Get));
Router.get("/:user_id/:round", ProtectedRoute_1.default, (0, CatchError_1.default)(Controller.GetProgilePictures));
